...
.include "rofont-half.inc"                      ; half-width font for level name and AIR
.include "rolevels.inc"                         ; level layout, sprite positions, colors, etc.
.include "rosprites-half.inc"                   ; half-width gameplay sprites and Willy
.include "roui-sprites.inc"                     ; unchanged full-width lives and cheat boot
...
.include "rotiles-half.inc"                     ; half-width tile (background) definitions
